...
public class StarsUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println("克隆泡泡糖对象为：(" + cStar.getPosition().getRow() + "," + cStar.getPosition().getColumn() + "-" +cStar.getType() + ")");
		System.out.println("两对象是否一致：" + (star == cStar));
		System.out.println("两对象的坐标对象是否一致：" + (star.getPosition() == cStar.getPosition()));
	}
